"""Point the Step1X-3D template at a new image tag. Refuses to touch other templates."""
...
EID = os.environ["RUNPOD_ENDPOINT_ID_STEP1X3D"].strip()
TID = os.environ["RUNPOD_STEP1X3D_TEMPLATE_ID"].strip()
# T2, Hi3DGen, Pixal3D, Direct3D-S2
OTHER_TEMPLATES = {"fclhts02av", "s15aqi9lxs", "pwcli28kc9", "88xqk7rbcd"}
...
def main() -> int:
    ...
    image = f"ghcr.io/satanexist/paradox_worker:step1x3d-sha-{args.sha}"
