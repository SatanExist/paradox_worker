"""Point the Pixal3D template at a new image tag. Refuses to touch other templates."""
...
EID = os.environ["RUNPOD_ENDPOINT_ID_PIXAL3D"].strip()
TID = os.environ["RUNPOD_PIXAL3D_TEMPLATE_ID"].strip()
OTHER_TEMPLATES = {"fclhts02av", "s15aqi9lxs"}  # T2, Hi3DGen
...
def main() -> int:
    ...
    parser.add_argument("sha", help="short sha of the image tag, e.g. 60ecb7c")
    args = parser.parse_args()
    image = f"ghcr.io/satanexist/paradox_worker:pixal3d-sha-{args.sha}"
